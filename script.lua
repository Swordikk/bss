...
Tab:AddToggle({
	...
	Callback = function(Value)
		while Value == true do
			...
			path:ComputeAsync(HumanoidRootPart.Position, _G.Selectfield.Position)
			...
			if _G.AutoConvert == true then
				if Pollen.Value >= Capacity.Value then
					local PathfindingService = game:GetService("PathfindingService")
					local path = PathfindingService:CreatePath()
					path:ComputeAsync(HumanoidRootPart.Position, game:GetService("Players").LocalPlayer.SpawnPos.Value.Position)
...
Tab:AddDropdown({
	...
	Callback = function(Value)
		if Value == "Pine Tree Forest" then
			_G.Selectfield = workspace.FlowerZones["Pine Tree Forest"]
		elseif Value == "Pepper Patch" then
			_G.Selectfield = workspace.FlowerZones["Pepper Patch"]
		elseif Value == "Rose Field" then
			_G.Selectfield = workspace.FlowerZones["Rose Field"]
		elseif Value == "Stump Field" then
			_G.Selectfield = workspace.FlowerZones["Stump Field"]
		elseif Value == "Blue Flower Field" then
			_G.Selectfield = workspace.FlowerZones["Blue Flower Field"]
		elseif Value == "Bamboo Field" then
			_G.Selectfield = workspace.FlowerZones["Bamboo Field"]
		elseif Value == "Spider Field" then
			_G.Selectfield = workspace.FlowerZones["Spider Field"]
		elseif Value == "Mountain Top Field" then
			_G.Selectfield = workspace.FlowerZones["Mountain Top Field"]
		elseif Value == "Strawberry Field" then
			_G.Selectfield = workspace.FlowerZones["Strawberry Field"]
		elseif Value == "Cactus Field" then
			_G.Selectfield = workspace.FlowerZones["Cactus Field"]
		elseif Value == "Coconut Field" then
			_G.Selectfield = workspace.FlowerZones["Coconut Field"]
		elseif Value == "Mushroom Field" then
			_G.Selectfield = workspace.FlowerZones["Mushroom Field"]
		elseif Value == "Pumpkin Patch" then
			_G.Selectfield = workspace.FlowerZones["Pumpkin Patch"]
		elseif Value == "Clover Field" then
			_G.Selectfield = workspace.FlowerZones["Clover Field"]
		elseif Value == "Pineapple Patch" then
			_G.Selectfield = workspace.FlowerZones["Pineapple Patch"]
		elseif Value == "Dandelion Field" then
			_G.Selectfield = workspace.FlowerZones["Dandelion Field"]
		elseif Value == "Sunflower Field" then
			_G.Selectfield = workspace.FlowerZones["Sunflower Field"]
		end
	end
})
